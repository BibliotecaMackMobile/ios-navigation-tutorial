...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [dic2 adicionaPalavra:@"Elefante" letraGrande:@"E" imagem:[UIImage imageNamed:@"e.jpeg"]];
    Dicionario *dic6 = [[Dicionario alloc]init];
    [dic6 adicionaPalavra:@"Foca" letraGrande:@"F" imagem:[UIImage imageNamed:@"f.jpeg"]];
    ...
    [dic8 adicionaPalavra:@"Hipopótamo" letraGrande:@"H" imagem:[UIImage imageNamed:@"h.jpeg"]];
    Dicionario *dic9 = [[Dicionario alloc]init];
    [dic9 adicionaPalavra:@"Iguana" letraGrande:@"I" imagem:[UIImage imageNamed:@"i.jpg"]];
